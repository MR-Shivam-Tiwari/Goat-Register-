      ...
      {sortedBreeds.map((breed) => {
        ...
        return (
          <div key={breed.id} className="relative group">
            ...
            >
              {/* IMAGE SECTION */}
              <div className="aspect-[4/3] w-full overflow-hidden bg-[#F5F4F0] relative flex items-center justify-center p-2.5 pt-12 rounded-t-xl border-b border-[#491907]/5">
                {hasImage ? (
                  <img
                    src={
                    ...
                    className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-700 ease-out rounded-lg border border-[#491907]/10 shadow-sm"
                  />
                ) : (
