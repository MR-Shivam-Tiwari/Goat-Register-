            ...
            {goats.map((g, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <td
                    className="p-3 text-center font-black text-nowrap px-6 uppercase leading-none text-gray-900 opacity-80"
                    style={{ fontSize: "11px" }}
                  >
                    {g.breed_name || g.breed_alias}
                  </td>
                  <td
                    className="p-3 text-center font-black text-blue-700 bg-blue-50/20 px-6 uppercase leading-none"
                    style={{ fontSize: "12px" }}
                  >
                  ...
                  <td className="p-1 px-4 text-nowrap  ">{g.source || "-"}</td>
